...
#  - Increment the starting integer by 2 to get the next integer in the sequence - Step 3
#  - Break out of the loop if length of row = row length - Step 4
